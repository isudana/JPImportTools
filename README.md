...
- **Tax Payment Instructions** (`/tax-payment-instructions`) — step-by-step guide to paying a Sri Lanka Customs assessment through the BOC Flex App (Easy Actions → Bill Payments → New Bill → Sri Lanka Customs), with the exact form fields to fill in from the Assessment notice.
