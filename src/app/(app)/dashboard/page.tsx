...
import { UTILITIES } from "@/app/(app)/page";
...
const LIFECYCLE: LifecyclePhase[] = [
  {
    ...
    resourceTitles: ["Bank of Ceylon Exchange Rates", "Sri Lanka Customs Exchange Rates"],
  },
  {
  ...
  },
  {
    ...
    resourceTitles: ["Vehicle Shipping Schedules", "HIPG Berthing Schedule", "Track My Custdeck"],
  },
  {
    phase: "Clearance",
    utilityHrefs: ["/documents-checklist", "/tax-payment-instructions"],
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="space-y-4 rounded-lg border border-gray-200 bg-white p-4">
        ...
        <div className="border-t border-gray-100 pt-4">
          <label className="block">
            <span className="block text-xs font-medium text-gray-500">Vehicle (Yellow Book model)</span>
            <input
